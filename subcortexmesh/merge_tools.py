...
def merge_all(
    ...
    metric: str, Sequence
        The name(s) of the metric(s) to be computed. Options include "thickness", "curvature", "surfarea", and default is all of them. Alternatively, the name(s) of metric(s) specified for cifti_extract() outputs.
    plot_merged: bool
